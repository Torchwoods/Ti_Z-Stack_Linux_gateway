...
#define COMMAND_SS_IAS_ZONE_STATUS_INIT_NORMAL_OP_MODE_RSP               0x02
#define COMMAND_SS_IAS_ZONE_STATUS_INIT_TEST_MODE_RSP                    0x03
...
typedef struct
{
  ...
  zclSS_InitNormalOpModeResponse_t         pfnInitNormalOpModeResponse;       // Initiate Normal Operation Mode Response command
  zclSS_InitTestModeResponse_t             pfnInitTestModeResponse;           // Initiate Test Mode Response command
...
#ifdef ZCL_ZONE
/*
 *  Send a InitNormalOperationMode Response Cmd  ( IAS Zone Cluster )
 *  Use like:
 *      zclSS_IAS_Send_ZoneStatusInitNormalOperationModeResponseCmd( uint16 srcEP, afAddrType_t *dstAddr, uint8 disableDefaultRsp, uint8 seqNum );
 */
#define zclSS_IAS_Send_ZoneStatusInitNormalOperationModeResponseCmd(a,b,c,d) zcl_SendCommand( (a), (b), ZCL_CLUSTER_ID_SS_IAS_ZONE,\
                                                                          COMMAND_SS_IAS_ZONE_STATUS_INIT_NORMAL_OP_MODE_RSP, TRUE,\
                                                                          ZCL_FRAME_SERVER_CLIENT_DIR, (c), 0, (d),  0, NULL )
/*
 *  Send a InitTestMode Response Cmd  ( IAS Zone Cluster )
 *  Use like:
 *      zclSS_IAS_Send_ZoneStatusInitTestModeResponseCmd( uint16 srcEP, afAddrType_t *dstAddr, uint8 disableDefaultRsp, uint8 seqNum );
 */
#define zclSS_IAS_Send_ZoneStatusInitTestModeResponseCmd(a,b,c,d) zcl_SendCommand( (a), (b), ZCL_CLUSTER_ID_SS_IAS_ZONE,\
                                                                          COMMAND_SS_IAS_ZONE_STATUS_INIT_TEST_MODE_RSP, TRUE,\
                                                                          ZCL_FRAME_SERVER_CLIENT_DIR, (c), 0, (d),  0, NULL )
/*
